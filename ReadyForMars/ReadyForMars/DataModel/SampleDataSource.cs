...
namespace ReadyForMars.Data
{
    ...
    public abstract class SampleDataCommon : ReadyForMars.Common.BindableBase
    {
        ...
        private string _sol_txt = string.Empty;
        public string Sol_Txt
        {
            get { return this._sol_txt; }
            set { this.SetProperty(ref this._sol_txt, value); }
        }
